                  ...
                  <Transition name="statusesMenu">
                    <div v-if="assigneeMenuOpen"
                      ...
                      <div @click="changeIssue({'assign_to': null})"
                        ...
                        <h5 class="m-0 ms-3 fw-normal text-capitalize">unassignee</h5>
                      </div>
                      <div
                  ...
                  <div class="d-flex justify-content-start align-items-center p-3">
                    <div class="symbol symbol-circle symbol-30px overflow-hidden">
                      <img v-if="backlogStore?.issueInfoArray?.user?.photo"
                           ...
                           class="w-30px h-30px"/>
                      <span v-else class="symbol-label text-inverse-warning fs-2 w-30px h-30px rounded-circle fw-bold"
                    ...
                    <span class="ms-3 fs-6 fw-normal text-capitalize">{{

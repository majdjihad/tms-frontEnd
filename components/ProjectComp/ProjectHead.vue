                  ...
                  <div class="position-relative">
                    ...
                    <Transition name="projectActionsMenu">
                      <div
                        ...
                        class="projectActionsMenu menu-gray-800 menu-state-bg-light-primary fw-semibold bg-light rounded shadow position-absolute overflow-hidden p-0"
                      >
                        ...
                        <div class="separator opacity-75 m-0"></div>
                        <div class="m-0">
                          <span
                            class="btn btn-sm btn-light rounded-0 fs-6 w-100 text-start"

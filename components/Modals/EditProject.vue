...
function formHandle() {
  !data.name ? errorMsg.errorName = 'Title is required' : !data.description ? errorMsg.errorDescription = 'Description is required' : ''
...
const { submit, inProgress, validationErrors: errors, } = useSubmit(() => editProject(projectsStore?.project?.project_identify, projectData), {
    ...
    <div class="modal-dialog mw-650px">
      <div class="modal-content">
        ...
        <div class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
          ...
          <form @submit.prevent="formHandle" class=" text-center" id="editProjectForm">

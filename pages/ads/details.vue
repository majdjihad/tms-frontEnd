  ...
  <div class="container py-4 py-lg-5">
    ...
    <div class="row g-4 flex-row-reverse">
      <main class="col-lg-9 order-1 order-lg-2">
        ...
        <div class="card shadow-sm p-9">
          ...
          <div class="row g-3 mb-3">
            ...
            <div class="col-md-4">
              <div class="gallery-thumbs d-grid gap-3">
                <img
      ...
      <aside class="col-lg-3 order-2 order-lg-1">
        ...
        <div class="card mb-3">
          <div class="card-body">
            <h3 class="mb-3 border-bottom border-dark pb-3">بيانات الناشر</h3>
            ...
            <div class="user-data gap-2 my-3">
              <button
                class="d-flex w-100 align-items-center btn p-0 mb-4"
            ...
            <ul class="list-unstyled small-note p-0 m-0">
              <li class="row gap-0">
                <Icon
                  ...
                  class="fs-2 text-primary col-2 mt-1"
                />

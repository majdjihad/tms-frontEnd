            ...
            <div class="row g-4">
              ...
              <div class="col-md-6">
                ...
                <input
                  name="phone"
                  type="tel"
                  class="form-control form-control-lg bg-light border-0 text-end rounded-0"
                  placeholder="+972592072429"
                />
              </div>
              <div class="col-md-6">
                ...
                <input
                  ...
                  type="email"
                  class="form-control form-control-lg bg-light border-0 rounded-0"
                  placeholder="husseinsawalhy8@gmail.com"
                />
              </div>
              <div class="col-md-6">

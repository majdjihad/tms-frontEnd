...
<template>
  <div>
    <!--begin::Root-->
    <div class="d-grid min-vh-100" style="grid-template-rows: auto auto 1fr auto;" id="kt_app_root">
      <!--begin::Header Section-->
      <div class="mb-0" id="home">
        <!--begin::Wrapper-->
        <div
            class="bgi-no-repeat bgi-size-contain bgi-position-x-center bgi-position-y-bottom landing-hero-bg"
            style="
            ...
            <div class="container h-80px">
              ...
              >
                ...
                <div class="flex-equal text-end ms-1">
                  <NuxtLink to="/login" class="btn btn-outline-primary text-white border border-secondary me-5">Log In</NuxtLink>
                  <NuxtLink to="/join" class="btn btn-primary"> Sign Up</NuxtLink>
                </div>
                <!--end::Toolbar-->
              </div>
              <!--end::Wrapper-->
